{!! Form::open(['method' => 'POST', 'route' => ['expenses.store', $month->id], 'class' => 'form-horizontal']) !!}
       ...
       @if( count($errors) )
        ...
        @endif
    <div class="modal fade" id="ExpenseCreate" tabindex="-1" role="dialog" aria-labelledby="ExpenseModal">
        ...
        <div class="modal-content">
            ...
            <div class="card-content">
              <div class="modal-header">
                ...
                <h4 class="modal-title" id="ExpenseModal">သုံးငွေ အသစ်ထည့်မည်</h4>
              </div>
                  ...
                  <div class="row" style="margin-bottom: 20px;">
                    <div class="col-md-6">
                      <div class="form-group{{ $errors->has('date') ? ' has-error' : '' }} label-floating has-success">
                          ...
                          {!! Form::date('date', null, ['class' => 'form-control', 'required' => 'required', 'autofocus'=>'autofocus']) !!}
                          <small class="text-danger">{{ $errors->first('date') }}</small>
                      </div>
                      <div class="form-group{{ $errors->has('name') ? ' has-error' : '' }} label-floating has-success">
                          {{-- {!! Form::label('name', 'ငွေသွင်း') !!} --}}
                          {!! Form::text('name', null, ['class' => 'form-control', 'required' => 'required', 'placeholder' => 'ငွေထုတ်']) !!}
                    ...
                    <div class="col-md-5 col-md-offset-1">
                      <div class="form-group{{ $errors->has('income_head_id') ? ' has-error' : '' }} label-floating has-success">
                          ...
                          {!! Form::select('expense_head_id', $expense_heads, null, ['class' => 'form-control', 'required' => 'required', 'placeholder'=>'-- သုံးငွေစာရင်း ခေါင်းစဉ် --']) !!}
